...
insert into users(username, password, firstname, lastname, last_password_reset, authorities, enabled) values('korisnik', '$2a$10$PZ.A0IuNG958aHnKdfgsseD9k44EOi1Ny0VlAn.ygrGcgmVcg8PRK', 'Petar', 'Petrovic', null, 'USER', 't');
